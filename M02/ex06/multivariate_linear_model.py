...
if __name__ == '__main__':
    ...
    # got 19 from others people code as well as mine for first result
    ...
    print(f"MSE Score: {my_lreg.mse_(Y, my_lreg.predict_(X_3))}")
    ...
    print(f"MSE Score: {my_lreg.mse_(Y, my_lreg.predict_(X))}")
    theta = np.array(([[383.94598482], [-24.29984158],   [5.67375056],  [-2.66542654]]))
    my_lreg = MyLR(theta, alpha=9e-5, max_iter=500000)
    print(f"MSE Score: {my_lreg.mse_(Y, my_lreg.predict_(X))}")
    print()
